...
<%--    // form에서 input으로 가져온 name에 일치하는 객체로 넘어온 정보들이 모두 자동으로 세팅된다.--%>
    ...
    Password: <jsp:getProperty name="user" property="password"/> <br><br>

    <jsp:include page = "search.jsp" flush="true"/><br>

    <p>input 태그의 name 속성이 userInfo 클래스의 프로퍼티 이름(name, password)과 완벽하게 일치해야 "jsp: setProperty"가 작동합니다.</p> <br>
